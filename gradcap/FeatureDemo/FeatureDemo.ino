...
void loop() {
    ...
    scrollingLayer.start("Charles Wang", 1);
...
#if (DEMO_DRAWING_INTRO == 1)
    {
        ...
        scrollingLayer.setSpeed(40);
        scrollingLayer.setFont(font6x10);
        scrollingLayer.start("Here we go!", 1);
...
#if (DEMO_DRAWING_PIXELS == 1)
    {
        ...
        scrollingLayer.setSpeed(40);
        scrollingLayer.setFont(font6x10);
        scrollingLayer.start("UMD ECE 2017", 1);
...
#if (DEMO_DRAWING_LINES == 1)
    {
        ...
        scrollingLayer.setSpeed(40);
        scrollingLayer.setFont(font6x10);
        scrollingLayer.start("Thanks Mom and Dad!", 1);
        ...
        scrollingLayer.start("Thanks guys!", 1);
...
#if (DEMO_DRAWING_RECTANGLES == 1)
    {
        ...
        scrollingLayer.setSpeed(40);
        scrollingLayer.setFont(font6x10);
        scrollingLayer.start("Stack Overflow", 1);
...
#if (DEMO_DRAWING_FILLED == 1)
    {
        ...
        scrollingLayer.setSpeed(40);
        scrollingLayer.setFont(font6x10);
        scrollingLayer.start("And caffeine", 1);
...
#if (DEMO_DRAW_CHARACTERS == 1)
    {
        ...
        scrollingLayer.setSpeed(40);
        scrollingLayer.setFont(font6x10);
        scrollingLayer.start("Graduation: #lit", 1);
        ...
        backgroundLayer.drawString(leftEdgeOffset, matrix.getScreenHeight() / 2, {0, 0xff, 0}, "It's");

        delay(delayBetweenCharacters);
        backgroundLayer.swapBuffers();

        // draw string but clear the background
        backgroundLayer.drawString(leftEdgeOffset, matrix.getScreenHeight() / 2, {0, 0xff, 0}, {0,0,0}, "Me!");
...
#if (DEMO_FONT_OPTIONS == 1)
    {
        ...
        backgroundLayer.fillScreen({0, 0x80, 0x80});
        backgroundLayer.drawString(leftEdgeOffset, matrix.getScreenHeight() / 2, {0xff, 0, 0}, "CAN");
        delay(delayBetweenCharacters);
        backgroundLayer.swapBuffers();

        backgroundLayer.setFont(font5x7);
        backgroundLayer.fillScreen({0, 0x80, 0x80});
        backgroundLayer.drawString(leftEdgeOffset, matrix.getScreenHeight() / 2, {0xff, 0, 0}, "YOU");
        delay(delayBetweenCharacters);
        backgroundLayer.swapBuffers();

        backgroundLayer.setFont(font6x10);
        backgroundLayer.fillScreen({0, 0x80, 0x80});
        backgroundLayer.drawString(leftEdgeOffset, matrix.getScreenHeight() / 2, {0xff, 0, 0}, "READ");
        delay(delayBetweenCharacters);
        backgroundLayer.swapBuffers();

        backgroundLayer.setFont(font8x13);
        backgroundLayer.fillScreen({0, 0x80, 0x80});
        backgroundLayer.drawString(leftEdgeOffset, matrix.getScreenHeight() / 2, {0xff, 0, 0}, "THIS?");
        delay(delayBetweenCharacters);
        backgroundLayer.swapBuffers();
...
#if (DEMO_MONO_BITMAP == 1)
    {
        ...
        scrollingLayer.setSpeed(40);
        scrollingLayer.setFont(font6x10);
        scrollingLayer.start("MORE ANIMATIONS", 1);
...
#if (DEMO_SCROLL_COLOR == 1)
    {
        ...
        scrollingLayer.setSpeed(40);
        scrollingLayer.setFont(font6x10);
        scrollingLayer.start("wheeeee", 1);
...
#if (DEMO_SCROLL_MODES == 1)
    {
        ...
        backgroundLayer.setFont(font3x5);
        scrollingLayer.setSpeed(40);
        backgroundLayer.drawString(0, matrix.getScreenHeight() / 2, {0xff, 0xff, 0xff}, "Charles Wang");
        backgroundLayer.swapBuffers();

        scrollingLayer.setMode(wrapForward);
        scrollingLayer.start("How long is this going to take?", 2);
...
#if (DEMO_SCROLL_SPEED == 1)
    {
        ...
        scrollingLayer.start("AHHHHHH", 3);
        backgroundLayer.swapBuffers();
...
#if (DEMO_SCROLL_ROTATION == 1)
    {
        ...
        scrollingLayer.start("UMD ECE 2017", 1);
        backgroundLayer.fillScreen(defaultBackgroundColor);
        backgroundLayer.drawString(1, matrix.getScreenHeight()/2, {0xff, 0xff, 0xff}, "");
        backgroundLayer.swapBuffers();
        while(scrollingLayer.getStatus());
...
#if (DEMO_RAW_BITMAP == 1)
    {
        ...
        scrollingLayer.setSpeed(40);
        scrollingLayer.setFont(font6x10);
        scrollingLayer.start("Yeah no I spent too much time on this", 1);
...
#if (DEMO_COLOR_CORRECTION == 1)
    {
        ...
        for (j = 0; j < 4; j++) {
            ...
            drawBitmap(0,0,&colorwheel);
            if (j%2) {
                backgroundLayer.drawString(1, 16, {0xff, 0, 0}, "");
                backgroundLayer.enableColorCorrection(true);
...
#if (DEMO_BACKGND_BRIGHTNESS == 1)
    {
        ...
        scrollingLayer.setSpeed(40);
        scrollingLayer.setFont(font6x10);
        scrollingLayer.start("Really extra I know", 1);
...
#if (DEMO_INDEXED_LAYER == 1)
    {
        ...
        indexedLayer.drawString(0, 6, 1, "Ni Hao");
...
#if (DEMO_REFRESH_RATE == 1)
    {
        ...
        scrollingLayer.setFont(font6x10);
        scrollingLayer.setOffsetFromTop(0);
        scrollingLayer.start("Flicker", 1);
